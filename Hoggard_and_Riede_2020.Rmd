...
```{r data import KEEP, echo = FALSE, message = FALSE}
...
```{r maps KEEP, echo=FALSE, message=FALSE, fig.width = 8, fig.height = 8, fig.align = "center"}
...
```{r overview KEEP, echo = FALSE, message = FALSE}
data %>% 
...
```{r breakdown KEEP, echo = FALSE, message = FALSE}
data %>% 
...
```{r file creation KEEP, echo = FALSE, message = FALSE}
...
```{r blade clean and display KEEP, echo = FALSE, message = FALSE}
...
```{r blade summary 1 KEEP, echo = FALSE, message = FALSE, fig.width = 6, fig.height = 4, fig.align = "center"}
a <- ggplot(blade_data_clean, aes(CODE, WEIGHT, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
b <- ggplot(blade_data_clean, aes(CODE, LENGTH, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
c <- ggplot(blade_data_clean, aes(CODE, WIDTH, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
d <- ggplot(blade_data_clean, aes(CODE, ELONGATION, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
e <- ggplot(blade_data_clean, aes(CODE, THICKNESS, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
f <- ggplot(blade_data_clean, aes(CODE, PLAT_DEPTH, fill = CLASSIFICATION)) +
         geom_boxplot() +
...
ggsave("Figure_2.png", dpi = 400, plot = last_plot())
```

```{r blade l w plot KEEP, echo = FALSE, message = FALSE, fig.width = 6, fig.height = 6, fig.align = "center"}
...
```{r blade tests KEEP, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r blade summary 2 KEEP, echo = FALSE, message = FALSE, fig.width = 6, fig.height = 4, fig.align = "center"}

g <- ggplot(blade_data_clean, aes(fill = RAW_MAT, x = CODE)) +
...
h <- ggplot(blade_data_clean, aes(fill = DORS_BLADE_PROF, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
i <- ggplot(blade_data_clean, aes(fill = BLADE_DET, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
j <- ggplot(blade_data_clean, aes(fill = BLADE_CURV, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
k <- ggplot(blade_data_clean, aes(fill = DORSAL_PATTERN, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
l <- ggplot(blade_data_clean, aes(fill = BULB_MORPH, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
m <- ggplot(blade_data_clean, aes(fill = BUTT_PREP_1, x = CODE)) +
  geom_bar(position = position_dodge(preserve = "single"), stat="count") +
...
```{r blade diversity 1 KEEP, echo = FALSE, message = FALSE,  fig.width = 6, fig.height = 4, fig.align = "center"}
